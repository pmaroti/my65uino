...
#define BAUD_DELAY 26   ; Approx delay for 4800 baud at 1MHz clock, divided by 8 timer
...
start:
    ...
    lda #0b1010_0000    ; Set B register direction: bit 6 is input button, bit 7 is output LED, bit 5 is output TX
    sta DDRB

loop:
                        ; Send  0x55 over serial
    lda #0x55           ; byte 0x55 is 01010101 which is good for testing on scope
    sta txbyte          ; this is the byte to send
